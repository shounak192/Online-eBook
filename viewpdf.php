...
<body style="overflow:hidden;">
    <h2 style="color:black">View e-Books<br> </h2><br>
...
if($total!=0)
{
    ...
    <table class="center">
        <tr class="active">
            <th style="font-family:georgia,garamond,serif; color:blue">Book Id</th>
            <th style="text-align:center;font-family:georgia,garamond,serif; color:blue">Book Name</th>
        </tr>
        <?php
